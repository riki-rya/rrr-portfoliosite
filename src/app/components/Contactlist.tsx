    ...
    <div className="flex flex-col items-center m-3 gap-3">
      <h1 className="text-2xl font-bold mb-8 text-center">Contact List</h1>
        <Button asChild className="w-40">
            <a href="https://twitter.com/_ixoray" target="_blank" rel="noopener noreferrer">
            <FaSquareXTwitter className="mr-2 h-4 w-4" />Twitter（X）
            </a>
        </Button>
        <Button asChild className="w-40">
            <a href="https://discord.com/users/476358303694192640" target="_blank" rel="noopener noreferrer">
